                        ...
                        <ul class="mx-auto navbar-nav navbar-nav-scroll">
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu" aria-labelledby="homeMenu">
                                    <<<<<<< HEAD <li> <a class="dropdown-item" href="/farmer/profile"><i
                                                class="mr-1 align-middle fas fa-fw fa-user"></i> View Profile</a>
                            </li>
                            <li> <a class="dropdown-item" href="/farmer/profile/{{Auth::user()->id}}">
                                    <i=======<li> <a class="dropdown-item" href="/farmer/viewProfile/"><i
